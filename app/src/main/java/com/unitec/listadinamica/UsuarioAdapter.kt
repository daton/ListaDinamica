    ...
    :ListAdapter<Usuario,UsuarioAdapter.UsuarioViewHolder>(UsuarioCallback) {
        ...
        class UsuarioViewHolder(itemView: View, val onClick: (Usuario) -> Unit ):
         RecyclerView.ViewHolder(itemView) {
             ...
             private val usuarioNombre: TextView=itemView.findViewById(R.id.textoNombre)
            private  val usuarioEmail:TextView=itemView.findViewById(R.id.textoEmail)
            private  val usuarioEdad :TextView =itemView.findViewById(R.id.textoEdad)
